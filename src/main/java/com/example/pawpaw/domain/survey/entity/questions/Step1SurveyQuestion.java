...
public enum Step1SurveyQuestion {
    GROSS_MOTOR_SKILLS(List.of(
            ...
            new Question(3, "난간을 붙잡고 한 계단에 양발을 모은 뒤 한 발씩 한 발씩 계단을 올라간다(좌우 한발씩 번갈아 올라가는 것은 아님).", "https://i.ibb.co/MSQrskd/1-3.png"),
            new Question(4, "정지되어 있는 공을 발로 찬다.", "https://i.ibb.co/RPmQ8yG/1-4.png"),
            new Question(5, "쪼그리고 앉은 자세에서 아무것도 붙잡지 않고 혼자서 일어선다.", null),
            new Question(6, "난간을 붙잡고 한 계단에 양발을 모은 뒤 한 발씩 한 발씩 계단을 내려간다(좌우 한발씩 번갈아 내려가는 것은 아님).", "https://i.ibb.co/QDMW63N/1-6.png"),
            new Question(7, "제자리에서 양발을 모아 동시에 깡충 뛴다.", "https://i.ibb.co/MsnXB7V/1-7.png"),
            new Question(8, "계단의 가장 낮은 층에 양발을 모아 바닥으로 뛰어내린다.", null)
    )),
    FINE_MOTOR_SKILLS(List.of(
            new Question(1, "(색)연필과 종이를 주면 선을 그리거나 낙서를 한다.", "https://i.ibb.co/yNZ95tL/1-1.png"),
            new Question(2, "블록을 두 개 쌓는다.", "https://i.ibb.co/T0sM6Pf/1-2.png"),
            new Question(3, "손가락을 바르게 들어(음식물이 쏟아지지 않도록) 입에 가져간다.", null),
            new Question(4, "(색)연필의 중간 부분을 잡는다(색연필의 아래 부분을 잡으면 ‘잘 할 수 있다’로 표시하세요).", "https://i.ibb.co/nkmYxdT/1-4.png"),
            new Question(5, "블록을 네 개 쌓는다.", "https://i.ibb.co/wMgh2Xy/1-5.png"),
            new Question(6, "블록 두 개 이상을 옆으로 나란히 줄을 세운다.", "https://i.ibb.co/JjTW1Fc/1-6.png"),
